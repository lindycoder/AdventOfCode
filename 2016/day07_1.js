...
function compute(data) {
    ...
    return ips.reduce((total, ip) => total += isTLS(ip) ? 1 : 0, 0)
}
...
describe('getABAs', function () {
    it('does', function () {
        expect(hasABBA("abba")).to.equal(true);
        expect(hasABBA("aaabbaaa")).to.equal(true);
        expect(hasABBA("aaaaabba")).to.equal(true);
        expect(hasABBA("abbaaaaa")).to.equal(true);
        expect(hasABBA("aabbaa")).to.equal(true);
    });
    it('doesnt', function () {
        expect(hasABBA("aaaa")).to.equal(false);
        expect(hasABBA("abcd")).to.equal(false);
        expect(hasABBA("a")).to.equal(false);
    });
});
...
describe('isSSL', function () {
    ...
    it('false if abba in brackets', function () {
        expect(isTLS("abcd[bddb]xyyx")).to.equal(false);
    });
    it('abba shouls have different letters', function () {
        expect(isTLS("aaaa[qwer]tyui")).to.equal(false);
    });
    it('should work if abba in string', function () {
        expect(isTLS("ioxxoj[asdfgh]zxcvbn")).to.equal(true);
    });
    it('should fail if abba in ANY bracket', function () {
        expect(isTLS("ioxxoj[asdfgh]a[bddb]xyyx")).to.equal(false);
    });
});

describe('Compute', function () {
    it('should do stuff', function () {
        var result = compute(`abba[mnop]qrst
abcd[bddb]xyyx
aaaa[qwer]tyui
