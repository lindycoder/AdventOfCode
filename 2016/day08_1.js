...
Matrix.prototype.litCount = function() {
    var lit = 0;
...
describe('litCount', function () {
    it('should count', function () {
        var matrix = new Matrix(3, 3);
        matrix.rect(2, 2);

        expect(matrix.litCount()).to.deep.equal(4);
    });
});
...
if (run_for_real) {
    ...
    console.log("Result is", compute(50, 6, `rect 1x1
rotate row y=0 by 5
rect 1x1
rotate row y=0 by 5
rect 1x1
