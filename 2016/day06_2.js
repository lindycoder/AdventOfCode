...
function compute(data) {
    ...
    return sets.map(lowestOccurence).join("");
}


function lowestOccurence(arr) {
    var mapping = {},
        letters = [];
    ...
    return letters.sort((a, b) => mapping[a] - mapping[b])[0];
}
...
describe('lowestOccurence', function () {
    it('should return the highest occurence', function () {
        expect(lowestOccurence(["a", "b", "a"])).to.equal("b");
        expect(lowestOccurence(["c", "d", "d"])).to.equal("c");
    });
});
