...
def compute(data):
    data = clean_empty_groups(filter_garbage(filter_ignored(data)))

    root = eval(data.replace("}", "]").replace("{", "["))

    return count_groups(root, 0)


def compute2(data):
    data = filter_ignored(data)

    return sum(len(r) for r in re.findall("<(.*?)>", data))
...
def filter_garbage(data):
    return re.sub("<.*?>", "", data)


def clean_empty_groups(data):
    return re.sub("{,+", "{", data)


def count_groups(root, parent_score):
    return sum(count_groups(g, parent_score + 1) for g in root) + 1 + parent_score


class DayTest(unittest.TestCase):
    def test_scoring1(self):
        input = """{}"""
        assert_that(compute(input), is_(1))

    def test_scoring2(self):
        input = """{{{}}}"""
        assert_that(compute(input), is_(6))

    def test_scoring3(self):
        input = """{{},{}}"""
        assert_that(compute(input), is_(5))

    def test_scoring4(self):
        input = """{{{},{},{{}}}}"""
        assert_that(compute(input), is_(16))

    def test_scoring5(self):
        input = """{<a>,<a>,<a>,<a>}"""
        assert_that(compute(input), is_(1))

    def test_scoring6(self):
        input = """{{<ab>},{<ab>},{<ab>},{<ab>}}"""
        assert_that(compute(input), is_(9))

    def test_scoring7(self):
        input = """{{<!!>},{<!!>},{<!!>},{<!!>}}"""
        assert_that(compute(input), is_(9))

    def test_scoring8(self):
        input = """{{<a!>},{<a!>},{<a!>},{<ab>}}"""
        assert_that(compute(input), is_(3))


class Day2Test(unittest.TestCase):
    def test_garbage_count1(self):
        input = """<>"""
        assert_that(compute2(input), is_(0))

    def test_garbage_count2(self):
        input = """<random characters>"""
        assert_that(compute2(input), is_(17))

    def test_garbage_count3(self):
        input = """<<<<>"""
        assert_that(compute2(input), is_(3))

    def test_garbage_count4(self):
        input = """<{!>}>"""
        assert_that(compute2(input), is_(2))

    def test_garbage_count5(self):
        input = """<!!>"""
        assert_that(compute2(input), is_(0))

    def test_garbage_count6(self):
        input = """<!!!>>"""
        assert_that(compute2(input), is_(0))

    def test_garbage_count7(self):
        input = """<{o"i!a,<{i<a>"""
        assert_that(compute2(input), is_(10))


class IngoringTest(unittest.TestCase):
    def test_filter_ignoring(self):
        assert_that(filter_ignored("""a!b!!cd"""), is_("acd"))


class GarbageTest(unittest.TestCase):
    def test_parse_groups(self):
        assert_that(filter_garbage("i<>o"), is_("io"))

    def test_filter_garbage2(self):
        assert_that(filter_garbage("i<aslihdeoind>o"), is_("io"))

    def test_filter_garbage3(self):
        assert_that(filter_garbage("i<<<<>o"), is_("io"))

    def test_filter_garbage4(self):
        assert_that(filter_garbage('i<{o"i,<{i<a>o'), is_("io"))


class CleanEmptyElementsTest(unittest.TestCase):
    def test_1(self):
        assert_that(clean_empty_groups("{}"), is_("{}"))
